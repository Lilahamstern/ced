<template>
  <div
    class="bg-gray-800 shadow shadow-t rounded max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl w-full"
  >
    <div class="flex pl-4 items-center h-32 md:h-24">
      <div class="w-full text-gray-600 relative">
        <div class="card-row">
          <h2 class="text-gray-400 text-md font-semibold truncate -mt-1">
            Project:
        ...
        <div class="card-row mt-10">
          ...
          <p class="info">
            <span class="label">Co2-ekv/m2:</span>
            {{project.Co}}
          </p>
        </div>
        ...
        <div class="tooltip" v-if="tooltipHover">
          <div
            class="bg-gray-900 opacity-75 text-white text-xs rounded py-1 px-3 right-0 bottom-full truncate"
          >{{project.id}}</div>
        </div>
        <div
          class="absolute right-0 -mt-6 -mr-3 cursor-pointer"
      ...
      <div
        class="flex items-center text-lg text-gray-500 hover:text-gray-600 hover-slide rounded-r h-full pl-1 pr-2 ml-1 cursor-pointer mx-auto"
        @click="gotoAbout"
      >
