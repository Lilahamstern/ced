...
type versionInformationRepository struct {
	db *sql.DB
}

func (repo *versionInformationRepository) Save(info *domain.VersionInformation) error {
...
func newVersionInformation(db *sql.DB) VersionInformationRepository {
	return &versionInformationRepository{
		db,
	}
}
